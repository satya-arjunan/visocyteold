...
class TPlot(object):
    ...
    def __init__(self):
        ...
        """
        self.node_selection = \
            visocyte.servermanager.sources.GlobalIDSelectionSource(FieldType="POINT")
        self.element_selection = \
            visocyte.servermanager.sources.GlobalIDSelectionSource(FieldType="CELL")
    ...
    def create_global_over_time_representation(self, c):
        ...
        rep = visocyte.servermanager.CreateRepresentation(plot, self.view)
        self._curve_reps[c.curve_index] = rep
        visocyte.servermanager.ProxyManager().RegisterProxy("representations", \
