...
void pqBlotShell::initialize()
{
  ...
  this->executePythonCommand("import visocyte\n");
  this->executePythonCommand("visocyte.compatibility.major = 3\n");
  this->executePythonCommand("visocyte.compatibility.minor = 5\n");
  this->executePythonCommand("from visocyte import servermanager\n");
  ...
  this->executePythonCommand("import visocyte.simple\n");
  this->executePythonCommand(
    "visocyte.simple.active_objects.view = servermanager.GetRenderView()\n");
