...
import visocyte.simple as smp



def getPVApplicationCore():
    return PythonQt.visocyte.pqPVApplicationCore.instance()
...
def getPQView(view):
    ...
    return PythonQt.visocyte.pqPythonQtMethodHelpers.findProxyItem(model, view.SMProxy)
...
def getMainWindow():
    ...
    for widget in QtGui.QApplication.topLevelWidgets():
        if isinstance(widget, PythonQt.private.VisocyteMainWindow):
            return widget
    #
