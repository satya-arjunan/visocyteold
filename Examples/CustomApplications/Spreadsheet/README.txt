This example demonstrates how to use the Visocyte application framework for
developing custom applications with work-flow different from that of Visocyte's.
...
* Building user inferface by subclassing QMainWindow
  - Interface does not use pipeline-browser/object-inspector framework at at
    all.
* Unlike standard Visocyte, we are not allowing user to split views or create
