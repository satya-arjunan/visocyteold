...
Adapted from the [Visocyte wiki](http://www.visocyte.org/Wiki/ParaView:Build_And_Install) which has more complete but dated instructions.
...
ParaView will be in `bin/visocyte.exe`

Other Variations
----------------
[ParaViewWeb](http://kitware.github.io/visocyteweb/docs/guides/os_mesa.html) uses ParaView as a server, so doesn't require the QT gui. It configures OSMesa instead.
