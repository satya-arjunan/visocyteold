...
4. Add some tests
    ...
    * Start `visocyte.exe -dr` to ignore prefs (disable registry)
    ...
    * Add all testing files to your topic.
    ...
    Some background is in the [testing design wiki](https://www.visocyte.org/Wiki/Testing_design).
...
It should be of the form:
    ...
    https://gitlab.kitware.com/<username>/visocyte/merge_requests/new

Follow these steps:

1.  In the "**Source branch**" box select the `<username>/visocyte` repository
    and the `my-topic` branch.

2.  In the "**Target branch**" box select the `visocyte/visocyte` repository and
...
page.  It is of the form:
    ...
    $ git fetch https://gitlab.kitware.com/$username/visocyte.git $branch
...
Builder names always follow this pattern:
  ...
  * project: always `visocyte` for visocyte
...
For a list of all builders, see:
  ...
  * [visocyte-expected](https://buildbot.kitware.com/builders?category=visocyte-expected)
  * [visocyte-superbuild](https://buildbot.kitware.com/builders?category=visocyte-superbuild)
  * [visocyte-experimental](https://buildbot.kitware.com/builders?category=visocyte-experimental)
