...
extern "C" void createpointsandallocatecells(int* numPoints, double* coordsArray, int* numCells)
{
...
extern "C" void addfields(int* nshg, int* vtkNotUsed(ndof), double* dofArray, int* compressibleFlow)
{
