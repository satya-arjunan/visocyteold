...
=========================================================================*/
// .NAME vtkSMTestDriver - A program to run visocyte-based clients for testing
...
private:
  ...
  {
    std::string Executable; //< fullpath to visocyte executable
    ProcessType Type;
    std::string TypeName;
    int ArgStart;
    int ArgEnd;
  ...
  ExecutableInfo ServerExecutable;       // fullpath to visocyte server executable + args
  ExecutableInfo RenderServerExecutable; // fullpath to visocyte renderserver executable + args
  ExecutableInfo DataServerExecutable;   // fullpath to visocyte dataserver executable + args
