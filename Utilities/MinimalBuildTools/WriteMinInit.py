...
def outputInitializeFunction(f, classList, outputFile):
    f.write(
        ...
        " */\n"
        "extern \"C\" void VTK_WRAP_CS_EXPORT vtkVisocyteMinInit_Initialize(\n"
...
#---------------------------------------------------------------------------
def outputVisocyteInitFile(classList, outputFile):
    f = open(outputFile, 'w')
    f.write(
        "//-------------------------------------------------------------------------\n"
        "/*\n"
        "* @file   vtkVisocyteMinInit.cxx\n"
        "*\n"
        ...
        "/* #undef VISOCYTE_BUILD_SHARED_LIBS */\n"
        "#endif\n"
        "#if defined(VISOCYTE_BUILD_SHARED_LIBS) && defined(_WIN32)\n"
...
def main(argv=None):
    ...
    outputVisocyteInitFile(classes, argv[2])
