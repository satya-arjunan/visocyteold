...
class VisocyteWebProgressUpdate(VisocyteWebProtocol):
    ...
    def updateProgress(self, caller):
        ...
        self.publish('visocyte.progress', { 'text': txt, 'progress': progress })
...
class VisocyteWebProxyManager(VisocyteWebProtocol):
    ...
    def create(self, functionName, parentId, initialValues = {}, skipDomain = False, subProxyValues = {}):
        ...
        newProxy = visocyte.simple.__dict__[allowed](**sanitizedInitialValues)
    ...
    def open(self, relativePath):
        ...
        if readerName:
            ...
            reader = visocyte.simple.__dict__[readerName](**kw)
        else:
