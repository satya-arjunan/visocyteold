...
public:
  ...
  * a GUI (eg Visocyte) can provide a mechanism for selecting which data arrays
  ...
  * should be read from the file. Visocyte queries these point arrays after
...
protected:
  ...
  // To allow visocyte gui to enable/disable scalar reading
