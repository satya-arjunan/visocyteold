...
public:
  ...
  std::string ServerExecutablePath; // fullpath to visocyte server executable
...
//-----------------------------------------------------------------------public
/*
 * This function is called the system running visocyte is a multicore
 ...
 * @param paraView the location of visocyte server
