  ...
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  vtkSmartPyObject module(PyImport_ImportModule("visocyte.detail.extract_selection"));
  CheckAndFlushPythonErrors();
  if (!module)
  {
    vtkErrorMacro("Failed to import `visocyte.detail.extract_selection` module.");
    return 0;
  }
  ...
  // call `visocyte.detail.annotation.execute_on_attribute_data(self)`
