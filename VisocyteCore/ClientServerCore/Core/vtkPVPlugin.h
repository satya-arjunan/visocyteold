 ...
 * `VISOCYTE_LOG_PLUGIN_VERBOSITY=<level>`  environment variable on all the processes
...
// not. The returned value is used to match visocyte version/compiler version
