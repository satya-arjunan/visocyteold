...
void vtkPythonProgrammableFilter::Exec(const char* script, const char* funcname)
{
  ...
  runscript += "from visocyte import vtk\n";
  runscript +=
    "from visocyte.modules.vtkPVClientServerCorePython import vtkPythonProgrammableFilter\n";
  ...
  runscript += "  from visocyte.vtk.numpy_interface import dataset_adapter\n";
  runscript += "  from visocyte.vtk.numpy_interface.algorithms import *\n";
