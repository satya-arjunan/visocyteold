  ...
  bool InitializePython()
  {
    if (!this->Initialized)
    {
      ...
      this->WrappingModule.TakeReference(
        PyImport_ImportModule("visocyte.modules.vtkPVClientServerCoreRendering"));
      ...
      this->PythonViewModule.TakeReference(PyImport_ImportModule("visocyte.python_view"));
      if (!this->PythonViewModule)
      {
        vtkGenericWarningMacro("Failed to import 'visocyte.python_view' module.");
        if (PyErr_Occurred())
        {
          PyErr_Print();
          PyErr_Clear();
