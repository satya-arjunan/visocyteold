  ...
  vtkInformation*, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  if (this->MPIMToNSocketConnection == 0 && this->ClientDataServerSocketController == 0)
  {
    ...
    {
      vtkVLogF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "pass-through");
...
#if VTK_MODULE_ENABLE_VTK_ParallelMPI
  vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "redistribute MxN (M=%d, N=%d)", m, n);
...
#if VTK_MODULE_ENABLE_VTK_ParallelMPI
  vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "gather-all");
...
#if VTK_MODULE_ENABLE_VTK_ParallelMPI
  vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "gather-to-0");
  int idx;
...
void vtkMPIMoveData::DataServerSendToRenderServer(vtkDataObject* output)
{
  ...
  vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "send-to-renderserver");
...
void vtkMPIMoveData::RenderServerReceiveFromDataServer(vtkDataObject* output)
{
  ...
  vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "receive-from-dataserver");
...
void vtkMPIMoveData::DataServerZeroSendToRenderServerZero(vtkDataObject* data)
{
  ...
  if (myId == 0)
  {
    ...
    vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "send-to-renderserver-root");
...
void vtkMPIMoveData::RenderServerZeroReceiveFromDataServerZero(vtkDataObject* data)
{
  ...
  if (myId == 0)
  {
    ...
    vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "receive-from-dataserver-root");
...
void vtkMPIMoveData::DataServerSendToClient(vtkDataObject* output)
{
  ...
  if (myId == 0)
  {
    vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "send-to-client");
...
#if VTK_MODULE_ENABLE_VTK_ParallelMPI
  vtkVLogScopeF(VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY(), "broadcast");
  int myId = this->Controller->GetLocalProcessId();
