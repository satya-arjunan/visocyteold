...
{
  return get_verbosity(PipelineVerbosityKey, "VISOCYTE_LOG_PIPELINE_VERBOSITY");
}
...
{
  return get_verbosity(PluginVerbosityKey, "VISOCYTE_LOG_PLUGIN_VERBOSITY");
}
...
{
  return get_verbosity(DataMovementVerbosityKey, "VISOCYTE_LOG_DATA_MOVEMENT_VERBOSITY");
}
...
{
  return get_verbosity(RenderingVerbosityKey, "VISOCYTE_LOG_RENDERING_VERBOSITY");
}
...
{
  return get_verbosity(ApplicationVerbosityKey, "VISOCYTE_LOG_APPLICATION_VERBOSITY");
}
