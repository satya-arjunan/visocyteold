 ...
 * interpreter instances. However Visocyte no longer has need for that and hence
...
class VTKPVCORE_EXPORT vtkClientServerInterpreterInitializer : public vtkObject
{
public:
