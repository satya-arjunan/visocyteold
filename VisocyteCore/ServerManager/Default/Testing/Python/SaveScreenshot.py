...
def RegressionTest(imageName):
    from visocyte.vtk.vtkTestingRendering import vtkTesting
    testing = vtkTesting()
    testing.AddArgument("-T")
    testing.AddArgument(smtesting.TempDir)
    testing.AddArgument("-V")
    testing.AddArgument(smtesting.DataDir + "/VisocyteCore/ServerManager/Default/Testing/Data/Baseline/" + imageName)
