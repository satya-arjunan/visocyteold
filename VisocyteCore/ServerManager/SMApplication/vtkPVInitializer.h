...
#include "visocyte_client_server.h"
#include "visocyte_server_manager.h"
...
class vtkPVInitializerPlugin : public vtkPVPlugin, public vtkPVServerManagerPluginInterface
{
  ...
  {
    visocyte_server_manager_initialize(xmls);
  }

  vtkClientServerInterpreterInitializer::InterpreterInitializationCallback
  GetInitializeInterpreterCallback() override
  {
    return visocyte_client_server_initialize;
  }
};

void visocyte_initialize()
{
