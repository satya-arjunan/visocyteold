...
try:
    ...
    if "visocyte" in sys.modules:
        from visocyte.vtk.vtkIOImage import (vtkPNGReader,
                                             ...
                                             vtkTIFFWriter,
                                             vtkJPEGWriter)
        from visocyte.vtk.vtkIOAsynchronous import vtkThreadedImageWriter
        from visocyte.vtk.vtkCommonDataModel import vtkImageData
        from visocyte import numpy_support as n2v
    else:
