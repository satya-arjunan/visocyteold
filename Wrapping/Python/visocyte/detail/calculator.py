...
from visocyte.vtk import vtkDoubleArray, vtkSelectionNode, vtkSelection, vtkStreamingDemandDrivenPipeline
from visocyte.modules import vtkPVClientServerCorePython
...
def get_arrays(attribs, controller=None):
    ...
    for key in attribs.keys():
        varname = visocyte.make_name_valid(key)
