...
def numpy_to_image(numpy_array):
  ...
  try:
    ...
    visocyte.print_error("Error: Cannot import numpy")
  ...
  try:
    ...
    visocyte.print_error("Error: Cannot import vtkmodules.util.numpy_support")
...
def figure_to_data(figure):
  ...
  try:
    ...
    visocyte.print_error("Error: Cannot import matplotlib")
...
def matplotlib_figure(width, height):
  ...
  try:
    ...
    visocyte.print_error("Error: Cannot import matplotlib.backends.backend_agg.FigureCanvasAgg")
  try:
    from matplotlib.figure import Figure
  except:
    visocyte.print_error("Error: Cannot import matplotlib.figure.Figure")
