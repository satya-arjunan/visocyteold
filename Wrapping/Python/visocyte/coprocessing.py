...
from visocyte.modules.vtkPVVTKExtensionsCore import *
import math
...
class CoProcessor(object):
    ...
    **Cinema Tracks**
    ...
    visocyte.cpstate. visocyte.cpstate uses accessor instances to set values and
    ...
    def RescaleDataRange(self, view, time):
        ...
        for rep in reps:
            ...
            from visocyte.vtk import vtkDoubleArray
